	...
	public void retour(Message msg) {
		...
		if(msg instanceof Connecte) {
			...
			if(msg instanceof Parler) {
				...
				fr.iso3d.swing.Personnage perso = wInt.getPlateau().getPersonnage(parle.getPerso());
				...
				Position pos;
				fr.iso3d.swing.Personnage perso = plateau.getPersonnage(p.getId());
				...
				Plateau plateau = wInt.getPlateau();
				Position pos;
				fr.iso3d.swing.Personnage perso = plateau.getPersonnage(ad.getId());
